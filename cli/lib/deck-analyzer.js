  ...
  for (const item of cards) {
    ...
    if (elements.length === 0) {
      ...
      for (const el of elements) {
        ...
        if (elName && elementBreakdown.hasOwnProperty(elName)) {
    ...
    if (type === 'Site') {
      if (elements.length === 0) {
        ...
        for (const el of elements) {
          const elName = el.id?.toLowerCase() || el.name?.toLowerCase();
          if (elName && siteElementBreakdown.hasOwnProperty(elName)) {
    ...
    if (typeElementBreakdown[type]) {
      if (elements.length === 0) {
        ...
        for (const el of elements) {
          const elName = el.id?.toLowerCase() || el.name?.toLowerCase();
          if (elName && typeElementBreakdown[type].hasOwnProperty(elName)) {
